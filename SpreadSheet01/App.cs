...
namespace SpreadSheet01
{
	class App : IExternalApplication
	{
		...
		private const string NAMESPACE_PREFIX = "SpreadSheet01.Assets";

		private const string PANEL_NAME = "SpreadSheet01";
		private const string TAB_NAME = "AO Tools";

		private const string BUTTON_NAME = "SpreadSheet01";
		private const string BUTTON_TEXT = "SpreadSheet01";
		...
		private const string CLASSPATH = "SpreadSheet01.";
