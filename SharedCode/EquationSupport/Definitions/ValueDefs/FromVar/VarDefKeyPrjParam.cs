...
{
	public class VarDefKeyPrjParam : AVarDef
	{
		public VarDefKeyPrjParam(
		...
		// {
		// 	AAmtBase ab = new AmtVarKey(Vd_VarPrjParam, value);
		...
		{
			return $"this is| {nameof(VarDefKeyPrjParam)} ({ValueStr})";
		}
