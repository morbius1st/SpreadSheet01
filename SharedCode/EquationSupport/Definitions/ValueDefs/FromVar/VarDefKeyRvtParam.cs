...
{
	public class VarDefKeyRvtParam : AVarDef
	{
		public VarDefKeyRvtParam(
		...
		// {
		// 	AAmtBase ab = new AmtVarKey(Vd_VarRvtParam, value);
		...
		{
			return $"this is| {nameof(VarDefKeyRvtParam)} ({ValueStr})";
		}
