...
{
	public class ValDefOpMathAdd : AValDefBaseString
	{
		public ValDefOpMathAdd(int index, string description, string valueStr, ValueType valType, 
	...
	public class ValDefOpMathSubt : AValDefBaseString
	{
		public ValDefOpMathSubt(int index, string description, string valueStr, ValueType valType, 
			int order, bool isNumeric = false) : base(index, description, valueStr, valType, VDG_STRING, order, isNumeric) { }
