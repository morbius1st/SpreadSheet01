...
{
	public class ValDefOpTextAdd : AValDefBaseString
	{
		public ValDefOpTextAdd(int index, string description, string valueStr, ValueType valType, 
	...
	public class ValDefOpTextSubt : AValDefBaseString
	{
		public ValDefOpTextSubt(int index, string description, string valueStr, ValueType valType, 
			int order, bool isNumeric = false) : base(index, description, valueStr, valType, VDG_STRING, order, isNumeric) { }
