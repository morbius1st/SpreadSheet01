...
namespace SpreadSheet01.Management
{
	public static class ErrorCodesAssist
	{
		...
		static ErrorCodesAssist()
		{
			...
			EC_MustExist[(int) ParamClass.PC_CHART][(int) PT_TYPE] 
				= ErrorCodes.RCHTDATA_TYPE_PARAM_MISSING_CS001197;
			EC_MustExist[(int) ParamClass.PC_CHART][(int) PT_INSTANCE] 
				= ErrorCodes.RCHTDATA_INSTANCE_PARAM_MISSING_CS001198;
			EC_MustExist[(int) ParamClass.PC_CHART][(int) PT_INTERNAL] 
				= ErrorCodes.RCHTDATA_INTERNAL_PARAM_MISSING_CS001199;
		}
	}
	...
	#region errors 135 to 169 / RevitChart
		...
		RCHT_CELL_HAS_ERROR_CS001135,
		RCHT_FAIL_TO_ADD_CS001036,
		RCHT_PARAM_HAS_ERROR_CS001137,
		RCHT_RCD_HAS_ERRORS_CS001138,
		RCHT_BAD_FILE_PATH_CS001142,
		RCHT_INVALID_PARAM_TYPE_CS001143,	// pram type not matched
		RCHT_BAD_UPDATE_TYPE_CS001144,
		RCHT_PROCESS_CHART_FAILED_CS001145,

	#endregion

	#region errors 170 to 199 / RevitChartData

		RCHTDATA_TYPE_PARAM_MISSING_CS001197,
		RCHTDATA_INSTANCE_PARAM_MISSING_CS001198,
		RCHTDATA_INTERNAL_PARAM_MISSING_CS001199,

	#endregion

	#region errors 200 to 224 / revit charts

		RCHTS_CHART_HAS_ERRORS_CS001200,
	...
	#region errors 300 thru 349 / general parameter errors

		PARAM_SEQ_VAL_INVALID_CS001300,
